...
plot(ax1,x,y1)
title(ax1,'Stator Current - Direct Line Start, b=1.265')
...
plot(ax1,x,y1)
title(ax1,'Rotor Flux - Direct Line Start, b=1.265')
...
y1 = Te;
plot(ax1,x,y1)
title(ax1,'Torque - Direct Line Start, b=1.265')
...
title(ax1,'Speed - Direct Line Start, b=1.265')
